...
class Vibration_Analyzer(Analyzer):
    ...
    def plot_transfer_function(self, channel_pairs=None, figsize=(14, 6)):
        ...
        for i, tf_dict in enumerate(pairs_to_plot):
            ...
            # Draw uncertainty band; only label on the first pair to avoid legend duplicates
            ax.fill_between(
                freqs,
                lower,
                upper,
    ...
    def plot_psd(self, channels=None, figsize=(14, 6)):
        ...
        for i, chan in enumerate(channels):
            ...
            # Draw uncertainty band; only label it on the first channel to avoid legend duplicates
            ax.fill_between(
                freqs,
                lower,
                upper,
